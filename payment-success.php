...
<head>
    ...
    <title>Payment Success - Sriji Vastra Shingar Sewa</title>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-10 col-lg-8 col-xxl-5 wow fadeInUp">
                    <div class="payment_success_text">
                        ...
                        <p>We appreciate your purchase! We can't wait to deliver your things to you.
                            <?php if (isset($_GET['order_number'])): ?>
                                ID of Order <b>#<?php echo htmlspecialchars($_GET['order_number']); ?></b>.
                            <?php endif; ?>
