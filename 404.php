...
<head>
    ...
    <title>404 Error - Sriji Vastra Shingar Sewa</title>
...
<body class="default_home">
    ...
    <!--=============================
        ERROR START
    =============================-->
    <section class="error_page mt_100 mb_100">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 m-auto">
                    <div class="error_text wow fadeInUp">
                        ...
                        <p>The page you are looking for might have been removed had its name changed or is temporarily
                            unavailable.</p>
                        <a class="common_btn" href="/">go back home <i class="fas fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
